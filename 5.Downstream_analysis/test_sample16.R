...
source('plot.R')
### path need to define
output_path = 'E:\\DRCTdb\\ignore\\downstream_result\\sample16\\'
rna_path = 'E:\\DRCTdb\\ignore\\scRNA-seq\\sample16\\sample16_Bone_marrow_RNA_Healthy_35k_processed.Rds'
atac_path = 'E:\\DRCTdb\\ignore\\bed\\sample16/'
ldsc_path = "E:/DRCTdb/ignore/LDSC_results/sample16/pvalues.tsv"
#### db path
