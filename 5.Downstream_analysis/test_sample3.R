...
source('plot.R')
### path need to define
output_path = 'E:\\DRCTdb\\ignore\\downstream_result\\sample3\\'
rna_path = 'F:\\public\\Human and mouse cell atlas\\Adult human RNA-seq\\human_cell_landscape.rds'
atac_path = 'E:\\DRCTdb\\ignore\\bed\\sample3/'
ldsc_path = "E:/DRCTdb/ignore/LDSC_results/sample3/pvalues.tsv"
#### db path
...
rna=seurat_sample_ct(rna,cell_num = 1000)
atac = dir(atac_path)
...
ct_use = ct_use[intersect(colnames(ldsc_result),ct_use$V1),]
