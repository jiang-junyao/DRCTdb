...
source('plot.R')
### path need to define
output_path = 'E:\\DRCTdb\\ignore\\downstream_result\\sample23\\'
rna_path = 'F:\\DRCTdb\\ignore\\scRNA-seq\\Sample23\\islet_intergrate_harmory_final.Rds'
atac_path = 'E:\\DRCTdb\\ignore\\bed\\sample23/'
ldsc_path = "E:/DRCTdb/ignore/LDSC_results/sample23/pvalues.tsv"
#### db path
